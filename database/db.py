...
def seed_db():
    ...
    expenses = [
        ...
        (user_id, 18.00,  "Transport",     "2026-06-03", "Bus pass top-up"),
        ...
        (user_id, 89.95,  "Shopping",      "2026-06-14", "New headphones"),
        (user_id, 25.00,  "Other",         "2026-06-18", "Miscellaneous"),
        (user_id, 11.50,  "Food",          "2026-06-20", "Lunch takeout"),
    ]
    conn.executemany(
